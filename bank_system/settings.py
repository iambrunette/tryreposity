...
SECRET_KEY = 'django-insecure-6zhcyccegl82kp&(vr#55g6qqg8v7zaxq)hb$e28ol4)$f7f1p'
...
LOGGING = {
    ...
    "filters": {
       "mask_card": {"()": "bank_system.log_filters.MaskCardFilter"},
    },
    "handlers": {
        "console": {
    ...
    "loggers": {
        ...
        "transfers": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}